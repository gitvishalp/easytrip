...
public class hotlpayserv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            if(r==null)
            {
                ...
                hp.setHbookingid(Integer.parseInt(request.getParameter("bookid")));
                hp.setTransid(Integer.parseInt(request.getParameter("transid")));
                hp.setTransdate(currentDate.toString());
                hp.setAmount(Integer.parseInt(request.getParameter("hbill")));
                int rs2=hp.HotelPay();
                if(rs2==1){
                       response.sendRedirect("views/hotelreceipt.jsp"); 
                }
                else{
                out.println("<script type=\"text/javascript\">");
