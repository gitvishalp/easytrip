...
public class trainpayserv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            if(r==null)
            {
                ...
                out.println("location='views/trainpayment.jsp';");
                out.println("</script>");
            }
            else
                {
                ...
                tp.setTbookingid(Integer.parseInt(request.getParameter("bookid")));
                tp.setTransid(Integer.parseInt(request.getParameter("transid")));
                tp.setTransdate(currentDate.toString());
                tp.setAmount(Integer.parseInt(request.getParameter("trainbill")));
                int rs2=tp.TrainPay();
                if(rs2==1){
                       response.sendRedirect("views/trainticket.jsp"); 
                }
                else{
                out.println("<script type=\"text/javascript\">");
