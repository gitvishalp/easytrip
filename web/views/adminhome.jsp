<%-- 
    Document   : adminhome
    Created on : 10 May, 2022, 7:15:17 PM
    Author     : dell
--%>
...
<html>
    ...
    <body>
       ...
       <div class="container" style="margin-top:150px; margin-bottom: 70px;">
           <center>  <div class="row mt-4 mb-4">
               
             <div class="col-md-4 mb-4">
                <div class="card" style="width: 22rem; background-image: linear-gradient(to bottom right, #ffcccc, #ffffcc);">
                    <img class="card-img-top" src="adflight.png" height="200" alt="Card image cap">
                    <div class="card-body">
                        <center><a href="manageflights.jsp"><h5 class="card-title-ad"><hr>Manage Flights</h5></a></center>
                    </div>
                </div>
             </div>
           ...
           <div class="col-md-4 mb-4">
                <div class="card" style="width: 22rem; background-image: linear-gradient(to bottom right, #ffcccc, #ffffcc);">
                    <img class="card-img-top" src="adtrain.png" height="200" alt="Card image cap">
                    <div class="card-body">
                        <center><a href="managetrains.jsp"><h5 class="card-title-ad"><hr>Manage Trains</h5></a></center>
                    </div>
                </div>
           </div>
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 22rem; background-image: linear-gradient(to bottom right, #ffcccc, #ffffcc);">
                    <img class="card-img-top" src="adhotel.png" height="200" alt="Card image cap">
                    <div class="card-body">
                        <center><a href="managehotels.jsp"><h5 class="card-title-ad"><hr>Manage Hotels</h5></a></center>
                    </div>
                </div>
            </div>
               <div class="col-md-4 mb-4">
                   <div class="card" style="width: 22rem; background-image: linear-gradient(to bottom right, #ffffcc, #99ffcc);">
                    <img class="card-img-top" src="adpack.png" height="200" alt="Card image cap">
                    <div class="card-body">
                        <center><a href="managepackages.jsp"><h5 class="card-title-ad"><hr>Manage Package</h5></a></center>
                    </div>
                </div>
           </div>
               <div class="col-md-4 mb-4">
                <div class="card" style="width: 22rem; background-image: linear-gradient(to bottom right, #ffffcc, #99ffcc);">
                    <img class="card-img-top" src="adbooking.png" height="200" alt="Card image cap">
                    <div class="card-body">
                        <center><a href="managebookings.jsp"><h5 class="card-title-ad"><hr>Manage Bookings</h5></a></center>
                    </div>
                </div>
           </div>
               <div class="col-md-4 mb-4">
                <div class="card" style="width: 22rem; background-image: linear-gradient(to bottom right, #ffffcc, #99ffcc);">
                    <img class="card-img-top" src="adcustomers.png" height="200" alt="Card image cap">
                    <div class="card-body">
                        <center><a href="managecustomers.jsp"><h5 class="card-title-ad"><hr>Manage Customers</h5></a></center>
                    </div>
                </div>
           </div>
               </div></center></div>
