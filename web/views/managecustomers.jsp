<%-- 
    ...
    Created on : 27 May, 2022, 2:53:46 PM
    Author     : dell
--%>
       ...
       <div class="container" style="margin-top:100px; margin-bottom: 30px;">
           ...
           <%
                 try{
                  ...
                  ResultSet r= c.CustomerSearch();
                  %>
                   <table>
                       <tr><td colspan="8">Manage Customers</td></tr>
                               <tr>
                           ...
                           while(r.next())
                           {
                               ...
                               <tr>
                                   <td><h6><% out.println(r.getString("custid"));%></h6></td>
                                   <td><h6><% out.println(r.getString("custname"));%></h6></td>
                                   <td><h6><% out.println(r.getString("email")); %></h6></td>
                                   <td><h6><% out.println(r.getString("addr"));%></h6></td>
                                   <td><h6><% out.println(r.getString("gender"));%></h6></td>
                                   <td><h6><% out.println(r.getString("mobno"));%></h6></td>
                                   <td><h6><% out.println(r.getString("passwd")); %></h6></td>
