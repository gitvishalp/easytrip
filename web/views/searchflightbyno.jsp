<%-- 
    Document   : searchflightbyno
    Created on : 9 May, 2022, 10:25:09 PM
    Author     : dell
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="searchflight" style="height: 300px; width: 650px">
                <form action="viewflightbyno.jsp">
                <table>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="txtflightno" placeholder="Flight Number" required="true"></td>
                    </tr>
                    <tr>
                        <td colspan="2"><center> <input type="Submit" value="Search Flight"></center></td> 
                    </tr>
                </table>
                    <center><h5><a href="searchflight.jsp">Search Flight By Flight Source</a> </h5></center>
                </form>
                </div>
