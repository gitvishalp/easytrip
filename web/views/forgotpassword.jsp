<%-- 
    ...
    Created on : 4 May, 2022, 1:17:19 PM
    Author     : dell
--%>
            ...
            <div class="col-lg-5">
                <div class="card3 card border-0 px-3 py-5">
                    <div class="row px-3 mb-4">
                        <center><span><font color="green" size="6px">Forget Password</font></span></center>
                        <hr>
                    </div>
                    <form action="../forgetserv">
                    <div class="row px-3"> 
                        <label class="mb-1"><h6 class="mb-0">Email Address</h6></label>
                         <input class="mb-4" type="text" name="txtemail" placeholder="Enter Registered email address">
                    </div>
                    <div class="row mb-3 px-3"> <button type="submit" class="btn btn-blue text-center">Send Password</button> </div>
                    
                    </form>
                    <font size="2px" color="red"><p>* You will receive an email at your registered email with your password.</p></font>
                </div>
