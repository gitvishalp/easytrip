<%-- 
    ...
    Created on : 28 Feb, 2022, 9:19:45 PM
    Author     : dell
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="searchflight" style="height: 400px;">
                <form action="viewtrains.jsp">
                    <table>
                      <tr>
                          <td colspan="3"><center><h3>Search Trains</h3><hr></center></td>       
                      </tr>          
                      <tr>
                        <td colspan="2">
                            <h5>Source</h5>
                    ...
                    <tr>
                        <td> <input type="text" name="source" placeholder="Source" required="true"></td>
                        <td><span><i class="bi bi-arrow-left-right"></i></span></td> 
                        <td><input type="text" name="destination" placeholder="Destination" required="true"></td>
                    </tr>
                    <tr>
                        <td><h5>Date</h5></td>
                        <td colspan="2"><input type="date" name="date" required="true"></td>
                    </tr>
                    <tr>
                        <td><h5>Class</h5></td>
                        <td colspan="2"><select name="class">
                                ...
                                <option value="3AC">THIRD CLASS AC</option>
                                <option value="2AC">SECOND CLASS AC</option>
                                <option value="1AC">FIRST CLASS AC</option>
                            </select></td>
                    </tr>
                    <tr>
                    <td colspan="3"><center> <input type="Submit" value="Search Trains"></center></td>  
                    </tr>
                    <tr>
                        <td colspan="2"><h6><a href="searchtrainbyno.jsp">Search Train By Number</a> </h6> </td> 
