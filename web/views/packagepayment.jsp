<%-- 
    Document   : packagepayment
    Created on : 26 May, 2022, 3:12:07 PM
    Author     : dell
--%>
            ...
            <form action="../packagepayserv">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="pbill" value="<%= r.getString("price") %>" readonly="true"></td>
                    </tr>
