<%-- 
    ...
    Created on : 28 Feb, 2022, 8:14:23 PM
    Author     : dell
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="searchflight" style="height: 430px;">
                <form action="viewflight.jsp">
                <table>
                    <tr>
                        <td colspan="3">
                    <center><h3> Search Flight</h3><hr></center>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        <td><input type="text" name="txtsource" placeholder="Source" required="true"></td>
                        <td><span><i class="bi bi-arrow-left-right"></i></span></td> 
                        <td><input type="text" name="txtdestination" placeholder="Destination" required="true"></td>
                    </tr>
                    <tr>
                        <td><h5>Departure Date</h5></td>
                    ...
                    <tr>
                    <td colspan="3"><center> <input type="Submit" value="Search Flights"></center></td> 
                    </tr>
                </table>
                    <center><h5><a href="searchflightbyno.jsp">Search Flight By Flight No</a> </h5></center>
                </form>
            </div></div>
