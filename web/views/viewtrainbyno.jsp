<%-- 
    Document   : viewtrainbyno
    Created on : 20 May, 2022, 10:45:26 AM
    Author     : dell
--%>
    ...
    <body>
        ...
        <hr height="100">
            ...
            <%--Searching Code ---%>
                ...
                <% 
                   if(request.getParameter("txttraino")!=null)
                   {
                       try{
                           train t= new train();
                           
                           t.setTrainno(Integer.parseInt(request.getParameter("txttraino")));
                           
                           ResultSet r= t.SearchTrainbyNo();
                           %>
                           <table>
                                <tr><td colspan="9"><center><h5 style="color: green;">Your Search Result</h5></center></td></tr>
                               <tr>
                                   <th><h6>Train No </h6></th>
                                   <th><h6>Train Name</h6></th>
                                   <th><h6>Departure Time</h6></th>
                                   <th><h6>Arrival Time</h6></th>
                                   <th><h6>Duration</h6></th>
                                   <th><h6>Source</h6></th>
                                   <th><h6>Destination</h6></th>
                                   <th><h6>Running Days</h6></th>
                                   <th><h6>Fare</h6></th>
                                    <th><h6>Book</h6></th>
                               </tr>
                           <%
                           while(r.next())
                           {
                               ...
                               <tr>
                                   <td><h6><% out.println(r.getString("trainno"));%></h6></td>
                                   <td><h6><% out.println(r.getString("trainnm"));%></h6></td>
                                   <td><h6><% out.println(r.getString("depttime")); %></h6></td>
                                   ...
                                   <td><h6><% out.println(r.getString("rundays"));%></h6></td>
                                   <td><h6><% out.println(r.getString("fare")); %></h6></td>
                                   <td><input type="button" value="Book Now" onclick="window.location.href='booktrain.jsp?tno=<%=r.getString("trainno")%>'"></td>
                               </tr>
