<%-- 
    Document   : trainpayment
    Created on : 24 May, 2022, 2:48:10 PM
    Author     : dell
--%>
...
<html>
    ...
    <body>
        ...
        <%
              ...
              tpayment objauto = new tpayment();

               transid = objauto.Autotransid();
        %>
        <div class="payment-form">
            <form action="../trainpayserv">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="trainbill" value="<%= session.getAttribute("tbill").toString() %>" readonly="true"></td>
                    </tr>
                    <tr>
