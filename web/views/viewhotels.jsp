<%-- 
    Document   : viewhotels
    Created on : 20 May, 2022, 10:22:11 AM
    Author     : dell
--%>
            ...
            <%
                if (request.getParameter("cityname") != null) {
                    try {
                        ...
                        h.setCity(request.getParameter("cityname"));
                        ResultSet r = h.SearchHotel();
            %>
            <table>
                <tr><td colspan="12"><center><h5 style="color: green;">Your Search Result</h5></center></td></tr> 
            <tr>
                ...
                <tr style="background-color:white">
                    ...
                    <td> <input type="button" value="Book Now" onclick="window.location.href='bookhotel.jsp?hid=<%=r.getString("hotelid")%>'"></td>
                </tr>
                <%
                            }
                        } catch (Exception ex) {
