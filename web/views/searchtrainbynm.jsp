<%-- 
    Document   : searchtrainbynm
    Created on : 10 May, 2022, 1:59:28 PM
    Author     : dell
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="searchflight" style="height: 270px; width: 700px;">
                <form action="viewtrainbynm.jsp">
                    <table>
                      <tr>
                          <td colspan="2"><center><h3>Search Trains</h3><hr></center></td>       
                      </tr>          
                    <tr>
                        <td><h5>Train Name</h5></td>
                        <td> <input type="text" name="trainnm" placeholder="Enter Train Name" required="true"></td>
                    </tr>
                    <tr>
                    <td colspan="2"><center> <input type="Submit" value="Search Trains"></center></td>  
                    </tr>
                    <tr>
                        <td><h6><a href="searchtrainbyno.jsp">Search Train By Number</a></h6></td> 
