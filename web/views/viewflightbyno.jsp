<%-- 
    Document   : viewflightbyno
    Created on : 20 May, 2022, 10:14:48 AM
    Author     : dell
--%>
...
<html>
    ...
    <body>
        ...
        <%----Content------%>
                ...
                <% 
                   if(request.getParameter("txtflightno")!=null)
                   {
                       try{
                           flight f=new flight();
                           
                           f.setFlightno(Integer.parseInt(request.getParameter("txtflightno")));
