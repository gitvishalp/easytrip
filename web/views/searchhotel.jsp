<%-- 
    ...
    Created on : 28 Feb, 2022, 10:24:25 PM
    Author     : dell
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="searchflight" style=" height: 350px; width: 700px;">

                <form action="viewhotels.jsp">
                    <table>
                        <tr>
                            <td colspan="2">
                        <center><h3>Search Hotel</h3><hr></center>
                        </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <font color="grey"><h5> Number of Rooms</h5></font>
                            </td>
                            <td>
                                <font color="grey"> <h5> Number of Persons </h5></font>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="number" name="txtrooms" value="01" min="1" required="true">
                            </td>
                            <td>
                                <input type="number" name="txtperson" value="01" min="1" required="true">
                            </td>
                        </tr>
                        <tr> 
                            <td colspan="2">
                        <center><input type="Submit" value="Search Hotels"></center>
                        </td>
                        </tr>    
                    </table>
                </form>
