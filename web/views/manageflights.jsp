<%-- 
    ...
    Created on : 21 May, 2022, 3:10:36 PM
    Author     : dell
--%>
       ...
       <div class="container" style="margin-top:150px; margin-bottom: 70px;">
             ...
             <div class="col-md-4 mb-4">
                <div class="card" style="width: 22rem; background-image: linear-gradient(to bottom right, #ffcccc, #ffffcc);">
                    <div class="card-body">
                        <center><a href="addflight.jsp"><h5 class="card-title-ad"><center><i class="bi bi-plus-circle"></i></center>Add New Flight</h5></a></center>
                    </div>
                </div>
             </div>
           <div class="col-md-4 mb-4">
                <div class="card" style="width: 22rem; background-image: linear-gradient(to bottom right, #ffffcc, #99ffcc);">
                    <div class="card-body">
                        <center><a href="updateflight.jsp"><h5 class="card-title-ad"><center><i class="bi bi-pencil-square"></i></center>Update Flight</h5></a></center>
                    </div>
                </div>
           </div></center>
        </div>
