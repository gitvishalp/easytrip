<%-- 
    Document   : package
    Created on : 23 Feb, 2022, 9:00:18 PM
    Author     : dell
--%>
    ...
    <body>
        ...
        <div class="container">
            <div class="searchflight" style="height: 300px; width: 650px;">
                <form action="viewpackage.jsp">
                <table>
                    <tr>
                        <td colspan="2">
                    <center><h3> Search Tour Package</h3><hr></center>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td> <input type="text" name="destination" placeholder="Tour City Name" required="true"></td>
                    </tr>
                    <tr>
                        <td>
                            <h5>No. of Persons</h5>
                        </td>
                        <td> <input type="number" name="txtperson" value="01" min="1" required="true"></td>
                    </tr>
                    <tr>
