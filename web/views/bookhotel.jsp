<%-- 
    Document   : bookhotel
    Created on : 25 May, 2022, 1:31:28 PM
    Author     : dell
--%>
...
<html>
    ...
    <body>
        ...
        <%!  int bookid,custid;%>
        <%
              hotelbooking hotb= new hotelbooking();
              bookid= hotb.AutoGenhbid();
              session.setAttribute("hbid", bookid);
              custid= Integer.parseInt(session.getAttribute("cid").toString());
            try {
                hotel h = new hotel();
                h.setHotelid(Integer.parseInt(request.getParameter("hid")));
                ResultSet r = h.SearchHotelbyno();
                while (r.next()) {
        %>
        <div class="booking-form" style="height: 570px;">
            <form action="../hotelbookingserv">
                <table>
                    <tr>
                        <td colspan="5"><h3>Hotel Booking Details</h3><hr></td>
                    </tr>
                    <tr>
                    <td><label><font color="green">Customer ID</font></label></td>
                    <td><input type="text" name="custid" value="<%= custid %>" readonly="true"></td>
                    <td colspan="2" rowspan="3"><% out.println("<img width='350' height='150' src=../DisplayPhotoServlet?id=" + r.getInt("hotelid") + "></img></p>");%></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="hotelid" value="<%= r.getString("hotelid")%>" readonly="true"></td>
                    </tr>
                    <tr>
                        <td><label>Hotel Name : </label></td>
                        <td><input type="text" name="hname" value="<%= r.getString("hotelnm")%>" readonly="true"></td>
                        <td><label>Hotel Address : </label></td>
                        <td><input type="text" name="haddr" value="<%= r.getString("hoteladdr")%>" readonly="true"></td> 
                    </tr>
                    <tr>
                        <td><label>Check-in Date : </label></td>
                        <td><input type="date" name="chkin"  required="true"></td>
                        <td><label>Check-out Date : </label></td>
                        <td><input type="date" name="chkout" required="true"></td>
                    </tr>
                    <tr>
                            <td><label> Persons: </label></td><td>
                            <input type="number" name="person" value="01" min="1" ></td>
                            <td><label> Childs: </label></td><td>
                            <input type="number" name="child" value="01" min="0" ></td>
                    </tr>
                     <tr>
                            <td><label>Rooms </label></td><td>
                            <input type="number" name="rooms" value="01" min="1" ></td>
                            <td><label>Price/Person </label></td>
                            <td><input type="text" name="price" value="<%=r.getString("price") %>" readonly="true"></td>
                    </tr>
                    <tr>
                            ...
                            <td rowspan="2"><input type="text" name="addr" placeholder="Address"></td>
                    </tr>
                    <tr>
