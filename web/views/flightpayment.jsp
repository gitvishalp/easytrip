<%-- 
    ...
    Created on : 22 May, 2022, 8:10:02 PM
    Author     : dell
--%>
...
<html>
    ...
    <body>
        ...
        <%
              ...
              fpayment objauto = new fpayment();
               transid = objauto.AutoFtransid();
              
        %>
        <div class="payment-form">
            <form action="../flightpayserv">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="fbill" value="<%= session.getAttribute("bill").toString() %>" readonly="true"></td>
                    </tr>
                    <tr>
