<%-- 
    Document   : viewtrains
    Created on : 20 May, 2022, 10:32:26 AM
    Author     : dell
--%>
                ...
                <% 
                   if(request.getParameter("source")!=null)
                   {
                       try{
                           ...
                           t.setSource(request.getParameter("source"));
                           t.setDestination(request.getParameter("destination"));
                           
                           ResultSet r= t.SearchTrain();
                           %>
                           <table>
                           <tr><td colspan="10"><center><h5 style="color: green;">Your Search Result</h5></center></td></tr> 
                             <tr>
