<%-- 
    Document   : bookflight
    Created on : 20 May, 2022, 12:27:19 PM
    Author     : dell
--%>
...
<html>
    ...
    <body>
        ...
        <%!  int bookid,custid;%>
        <%
              flightbooking objauto= new flightbooking();
              bookid=objauto.AutoGenBid();
              session.setAttribute("bid", bookid);
              custid= Integer.parseInt(session.getAttribute("cid").toString());
            try {
                flight f = new flight();
                f.setFlightno(Integer.parseInt(request.getParameter("fno")));
                ResultSet r = f.SearchFlightNo();
                while (r.next()) {
        %>
        <div class="booking-form">
            <form action="../flightbookingserv">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="deptime" value="<%= r.getString("deptime")%>" readonly="true"></td>
                        <td><label>Journey Date : </label></td>
                         <td><input type="date" name="jdate"  required="true"></td>
                    </tr>
                    <tr>
                        <td><label>Flight Number : </label></td>
                        <td><input type="text" name="flightno" value="<%= r.getString("flightno")%>" readonly="true"></td>
                        <td><label>Flight Name : </label></td>
                        <td><input type="text" name="flightnm" value="<%= r.getString("flightnm")%>" readonly="true"></td>
                    </tr>
                    <tr>
                     ...
                     <tr>
                        ...
                        <td><select name="class" required="true">
                                <option value="ECONOMY">ECONOMY</option>
                                <option value="PREMIUM">PREMIUM ECONOMY</option>
                                <option value="BUSSINESS">BUSINESS</option>
                                <option value="FIRSTCLASS">FIRST CLASS</option>
                            </select></td>
                            <td><label> No. of Persons: </label></td><td> <input type="number" name="person" value="01" min="1" ></td>
                     </tr>
                    <tr>
                            <td><label> No. of Childs: </label></td><td>
                            <input type="number" name="child" value="01" min="0" ></td>
                            <td><label>Fare/Person </label></td>
                            <td><input type="text" name="fare" value="<%=r.getString("fare") %>" readonly="true"></td>
                    </tr>
                     <%
                            }
                        } catch (Exception ex) {
