<%-- 
    Document   : viewtrainbynm
    Created on : 20 May, 2022, 10:37:37 AM
    Author     : dell
--%>
    ...
    <body>
        ...
        <hr height="100">
            ...
            <div class="search-table">
                ...
                <% 
                   if(request.getParameter("trainnm")!=null)
                   {
                       try{
                           train t= new train();
                           
                           t.setTrainnm(request.getParameter("trainnm"));
                           
                           ResultSet r= t.SearchTrainbynm();
                           %>
                           <table>
