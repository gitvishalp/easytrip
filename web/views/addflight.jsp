<%-- 
    Document   : addflight
    Created on : 8 May, 2022, 3:07:27 PM
    Author     : dell
--%>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
        ...
        <div class="container" style=" margin-top: 100px; margin-bottom:20px;">
            ...
            <div class="additems">
                <form action="../addflightserv">
                    <table>
                        <tr>
                            <td colspan="2">
                        <center><h2> <b>ADD NEW FLIGHT</b></h2><hr></center>
                        </td>
                        </tr>
                        <tr>
                            <td>Flight Number</td><td><input type="text" name="txtflightno" placeholder="Flight Number" required="true"></td>
                        </tr>
                        <tr>
                            <td>Flight Name</td><td><input type="text" name="txtflightnm" placeholder="Flight Name" required="true"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="3"><center> <input type="Submit" value="Add Flight"></center></td> 
                        </tr>
                    </table>
                </form>                      
            </div>                 
