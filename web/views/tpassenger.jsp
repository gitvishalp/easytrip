<%-- 
    Document   : tpassenger
    Created on : 24 May, 2022, 2:25:30 PM
    Author     : dell
--%>
...
<html>
    ...
    <body>
        ...
        <%
            tpassenger objauto = new tpassenger();

            seatno = objauto.Autoseatno();
            bookid = Integer.parseInt(session.getAttribute("tbid").toString());
            custid = Integer.parseInt(session.getAttribute("cid").toString());
            try {
                trainbooking fb = new trainbooking();
                fb.setTbookingid(bookid);
                ResultSet r = fb.SearchtBooking();
            ...
            <form action="../tpassengerserv">
                <table>
                    ...
                    <tr>
                        ...
                        <%
                            session.setAttribute("tbill", total);
                            %>
                    </tr>
                    <%
                            }
                    ...
                    <tr>
                        <td colspan="4"><hr><center><input type="button" onclick="window.location.href='trainpayment.jsp'"  value="Make Payment"></center></td>
                    </tr>
                </table>
            </form>
