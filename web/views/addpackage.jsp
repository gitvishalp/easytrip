<%-- 
    Document   : addpackage
    Created on : 9 May, 2022, 9:31:52 PM
    Author     : dell
--%>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
        ...
        <div class="container" style=" margin-top: 100px; margin-bottom:20px;">
            ...
            <div class="additems" style="height:900px;">
                <form action="addpackcode.jsp" enctype="multipart/form-data" method="post">
                    <table>
                        <tr>
                            <td colspan="2">
                        <center><h2> <b>ADD TOUR PACKAGE</b></h2><hr></center>
                        </td>
                        </tr>
                        <tr>
                            <td>Package ID</td><td><input type="text" name="txtpackid" placeholder="Package ID" required="true"></td>
                        </tr>
                        <tr>
                            <td>Package Name</td><td><input type="text" name="txtpacknm" placeholder="Package Name" required="true"></td>
                        </tr>
                        <tr>
                            <td>Description</td><td><input type="text" name="txtdesc" placeholder="Description" required="true"></td>
                        </tr>
                        <tr>
                            <td>Source</td><td><input type="text" name="txtsource" placeholder="Source" required="true"></td>
                        </tr>
                        <tr>
                            <td>Destination</td><td><input type="text" name="txtdest" placeholder="Destination" required="true"></td>
                        </tr>
                        <tr>
                            <td>Duration</td><td><input type="text" name="txtdur" placeholder="Duration" required="true"></td>
                        </tr>
                        <tr>
                            <td>Package Included</td><td><input type="text" name="txtinclude" placeholder="Package Included" required="true"></td>
                        </tr>
                        <tr>
                            <td>Package Image</td><td><input type="file" name="picfile" required="true"></td>
                        </tr>
                        <tr>
                            <td>Price</td><td><input type="text" name="txtfare" placeholder="Price" required="true"></td>
                        </tr>
                        <tr>
                            <td colspan="3"><center> <input type="Submit" value="Add Package"></center></td> 
                        </tr>
                    </table>
                </form>                      
            </div>                 
