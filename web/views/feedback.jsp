<%-- 
    Document   : feedback
    Created on : 7 May, 2022, 10:41:08 PM
    Author     : dell
--%>
        ...
        <div class="row d-flex">
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    ...
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src="feedback.png" class="image">
            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    <div class="row px-3 mb-4">
                        <center><span><font size="7px" color="green">Feedback</font></span></center>
                        <hr>
                    </div>
                    <form action="../feedbackserv">
                    <div class="row px-3"> 
                        <label class="mb-1"><h6 class="mb-0">From</h6></label>
                         <input class="mb-4" type="text" name="txtemail" placeholder="Email Address">
                    </div>
                        <div class="row px-3"> 
                        <label class="mb-1"><h6 class="mb-0">Message</h6></label>
                        <textarea rows="4" cols="50" name="txtmsg" placeholder="Message"></textarea>
                    </div>
