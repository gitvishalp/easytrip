<%-- 
    Document   : trainticket
    Created on : 25 May, 2022, 12:51:58 PM
    Author     : dell
--%>
...
<html>
    ...
    <body>
       ...
       <% 
                       bookingid=Integer.parseInt(session.getAttribute("tbid").toString());
                       
                       try{
                           trainbooking tb= new trainbooking();
                           tb.setTbookingid(bookingid);
                           ResultSet r= tb.SearchtBooking();
                           %>
                           <div class="reciept">
                           <table>
                               <tr>
                                   <td colspan="3"><h2>TRAIN TICKET & PAYMENT RECEIPT</h2></td>
                           ...
                           <tr><td colspan="4"><h6>Booking ID : <% out.println(r.getString("tbookingid"));%></h6></td></tr>
                           <tr>
                               <td><h6>Train No</h6></td>
                               <td><% out.println(r.getString("trainno"));%></td>
                               <td><h6>Flight Name</h6></td>
                               <td><% out.println(r.getString("trainnm"));%></td>
                           </tr>   
                           <tr>
                               <td><h6>Departure Time</h6></td>
                               <td><% out.println(r.getString("depttime"));%></td>
                         ...
                         <%
                             tpassenger pass= new tpassenger();
                             pass.setTbookingid(bookingid);
                             ResultSet r2= pass.Searchtpassenger();
                           ...
                           <%
                               tpayment tpay= new tpayment();
                               tpay.setTbookingid(bookingid);
                               ResultSet r3= tpay.Searchtpayment();
                               while (r3.next()){
                                %>
                                <tr>
