<%-- 
    Document   : login
    Created on : 3 Feb, 2022, 7:13:57 PM
    Author     : dell
--%>
        ...
        <div class="row d-flex">
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    ...
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src="login.jpg" class="image"> </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    ...
                    <div class="row px-3 mb-4">
                        <center><span><font color="green" size="7px">Login</font></span></center>
                        <hr>
                    </div>
                    <form action="../loginserv">
                    <div class="row px-3"> 
                        <label class="mb-1"><h6 class="mb-0">Email Address</h6></label>
                         <input class="mb-4" type="text" name="txtemail" placeholder="Enter a valid email address">
                    </div>
                    <div class="row px-3"> 
                        ...
                        <label class="px-3" for="checkid" style="word-wrap: break-word;">
                        <input id="checkid" type="checkbox" value="test"/>Remember Me</label> 
                    
                    <div class="row px-3">
                            <a href="forgotpassword.jsp" class="ml-auto  mt-2 mb-4">Forgot Password?</a>
                    </div>
                    
                    <div class="row mb-3 px-3"> <button type="submit" class="btn btn-blue text-center">Login</button> </div>
                    <div class="row mb-4 px-3"> <small class="font-weight-bold">Don't have an account? <a href="CustomerRegistration.jsp" class="text-danger ">Register</a></small> </div>
                    </form>
                </div>
            </div>
        </div>
